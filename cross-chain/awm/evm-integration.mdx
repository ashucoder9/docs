...
5. The off-chain relayer encodes the `SignedMessage` as the [predicate](https://github.com/ava-labs/coreth/blob/master/precompile/contracts/warp/#predicate-encoding) in the AccessList of a transaction to deliver on blockchain B
...
The Warp Precompile is broken down into three functions defined in the Solidity interface file [here](https://github.com/ava-labs/coreth/blob/master/precompile/contracts/warp/../../../contracts/contracts/interfaces/IWarpMessenger.sol).
...
This pre-verification is performed using the ProposerVM Block header during [block verification](https://github.com/ava-labs/coreth/blob/master/precompile/contracts/warp/../../../plugin/evm/block.go#L220) and [block building](https://github.com/ava-labs/coreth/blob/master/precompile/contracts/warp/../../../miner/worker.go#L200).
