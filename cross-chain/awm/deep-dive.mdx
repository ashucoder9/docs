...
- Avalanche P-Chain / [PlatformVM](https://github.com/ava-labs/avalanchego/tree/master/vms/platformvm/warp/../)
- [ProposerVM](https://github.com/ava-labs/avalanchego/tree/master/vms/platformvm/warp/../../proposervm/README.md)
...
Avalanache Warp Messages are verified within the context of a specific P-Chain height included in the [ProposerVM](https://github.com/ava-labs/avalanchego/tree/master/vms/platformvm/warp/../../proposervm/README.md)'s header. The P-Chain height is provided as context to the underlying VM when verifying the underlying VM's blocks (implemented by the optional interface [WithVerifyContext](https://github.com/ava-labs/avalanchego/tree/master/vms/platformvm/warp/../../../snow/engine/snowman/block/block_context_vm.go)).
