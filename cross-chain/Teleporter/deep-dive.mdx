...
- [Deployed Addresses](https://github.com/ava-labs/teleporter/blob/main/#deployed-addresses)
- [Setup](https://github.com/ava-labs/teleporter/blob/main/#setup)
  - [Initialize the repository](https://github.com/ava-labs/teleporter/blob/main/#initialize-the-repository)
  - [Dependencies](https://github.com/ava-labs/teleporter/blob/main/#dependencies)
- [Structure](https://github.com/ava-labs/teleporter/blob/main/#structure)
- [Run a local testnet in Docker](https://github.com/ava-labs/teleporter/blob/main/#run-a-local-testnet-in-docker)
  - [Start up the local testnet](https://github.com/ava-labs/teleporter/blob/main/#start-up-the-local-testnet)
  - [Additional notes](https://github.com/ava-labs/teleporter/blob/main/#additional-notes)
- [E2E tests](https://github.com/ava-labs/teleporter/blob/main/#e2e-tests)
  - [Run specific E2E tests](https://github.com/ava-labs/teleporter/blob/main/#run-specific-e2e-tests)
  - [Run the E2E tests on another network](https://github.com/ava-labs/teleporter/blob/main/#run-the-e2e-tests-on-another-network)
- [Upgradeability](https://github.com/ava-labs/teleporter/blob/main/#upgradeability)
- [Deploy Teleporter to a Subnet](https://github.com/ava-labs/teleporter/blob/main/#deploy-teleporter-to-a-subnet)
- [Deploy TeleporterRegistry to a Subnet](https://github.com/ava-labs/teleporter/blob/main/#deploy-teleporterregistry-to-a-subnet)
- [ABI Bindings](https://github.com/ava-labs/teleporter/blob/main/#abi-bindings)
- [Docs](https://github.com/ava-labs/teleporter/blob/main/#docs)
- [Resources](https://github.com/ava-labs/teleporter/blob/main/#resources)
...
- When deployed using [Nick's method](https://yamenmerhi.medium.com/nicks-method-ethereum-keyless-execution-168a6659479c#), `TeleporterMessenger` will be at the same address on all chains. See [Teleporter Contract Deployment](https://github.com/ava-labs/teleporter/blob/main/./utils/contract-deployment/README.md) and [Deploy Teleporter to a Subnet](https://github.com/ava-labs/teleporter/blob/main/#deploy-teleporter-to-a-subnet) for more details.

- `TeleporterRegistry` can be deployed to any address. See [Deploy TeleporterRegistry to a Subnet](https://github.com/ava-labs/teleporter/blob/main/#deploy-teleporterregistry-to-a-subnet) for details. The table above enumerates the canonical registry addresses on the Mainnet and Fuji C-Chains.
...
For more information on the registry and how to integrate with Teleporter dApps, see the [Upgradeability doc](https://github.com/ava-labs/teleporter/blob/main/./contracts/src/Teleporter/upgrades/README.md).
...
- [Teleporter Protocol Overview](https://github.com/ava-labs/teleporter/blob/main/./contracts/src/Teleporter/README.md)
...
- [Teleporter Upgradeability](https://github.com/ava-labs/teleporter/blob/main/./contracts/src/Teleporter/upgrades/README.md)
